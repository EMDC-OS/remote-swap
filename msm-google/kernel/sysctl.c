...
static struct ctl_table kern_table[] = {
...
#ifdef CONFIG_APP_AWARE
	{
		.procname		= "swapcache_flush",
		.data			= &swapcache_flush,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= swapcache_flush_handler,
	},
	{
		.procname		= "workingset_status",
		.data			= &workingset_status,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= workingset_status_handler,
	},
	{
		.procname		= "anon_uid_scan",
		.data			= &anon_uid_scan,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= anon_uid_scan_handler,
	},
	{
		.procname		= "find_lru_index",
		.data			= &find_lru_index,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= find_lru_index_handler,
	},
	{
		.procname		= "lru_scan_private",
		.data			= &lru_scan_private,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= lru_scan_private_handler,
	},
	{
		.procname		= "find_lru_index_mode",
		.data			= &find_lru_index_mode,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	},
	...
	{
		.procname		= "swapin_vma_tracking",
		.data			= &swapin_vma_tracking,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	},
	...
	{
		.procname		= "launchtime_before",
		.data			= &launchtime_before,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	},
	...
	{
		.procname		= "cold_page_threshold",
		.data			= &cold_page_threshold,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		.procname		= "stop_background_io",
		.data			= &stop_background_io,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		.procname		= "cloudswap_on",
		.data			= &cloudswap_on,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	...
	{
		.procname		= "send_to_flash",
		.data			= &send_to_flash,
		.maxlen			= sizeof(unsigned long),
		.mode			= 0644,
		.proc_handler	= send_to_flash_handler,
	},
	{
		.procname		= "send_to_nbd",
		.data			= &send_to_nbd,
		.maxlen			= sizeof(unsigned long),
		.mode			= 0644,
		.proc_handler	= send_to_nbd_handler,
	},
	{
		.procname		= "send_to_memory",
		.data			= &send_to_memory,
		.maxlen			= sizeof(unsigned long),
		.mode			= 0644,
		.proc_handler	= send_to_memory_handler,
	},
	{
		.procname		= "target_tgid",
		.data			= &target_tgid,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
		.proc_handler	= proc_dointvec,
	...
	{
		.procname		= "fault_all_zram_page",
		.data			= &fault_all_zram_page,
		.maxlen			= sizeof(unsigned int),
		.mode			= 0644,
