...
/*	if(page){
		...
		page->uid=current->cred->uid.val;
		//set_page_private(page,(unsigned long)current->cred->uid.val);
		
		//printk("page uid: %d ", current->cred->uid.val);
		//printk("page uid: %d ", page_private(page));
	}
	*/
#endif
