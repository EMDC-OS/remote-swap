...
sleep 10
adb shell "echo 0 > sys/kernel/mm/swap/vma_ra_enabled"
sleep 5
adb shell "cat sys/kernel/mm/swap/vma_ra_enabled"
sleep 5
adb shell "/data/blktrace/blktrace -d /dev/nbd0 -o - | /data/blktrace/blkparse -i - -o /data/blktrace/nbd_blktrace_no_ra " &
sleep 10
