num=${1}
	...
	STR9=`adb shell ps -ef | grep com.pubg.krmobile | grep -v network |awk 'NR == 1 { print $2; exit }'`
	
	adb shell ps -ef | grep system_server |awk 'NR == 1 { print $8; exit }'
	...
	adb shell ps -ef | grep com.pubg.krmobile | grep -v network |awk 'NR == 1 { print $8; exit }'
...
sleep 2
sleep 10
adb shell cat /proc/$STR9/maps > PU_maps_${num}.txt
sleep 10
adb shell pmap -x $STR9 > PU_pmap_${num}.txt
sleep 10
adb shell dmesg > PU_dmesgb_${num}.txt
sleep 30
cat PU_dmesgb_${num}.txt | grep vma | grep "swapin tgid" > cut_PU_dmesgb_${num}.txt
sleep 10
cat PU_dmesgb_${num}.txt | grep vma | grep "swapout tgid" > out_b_${num}.txt
sleep 10
sleep 10
adb shell dmesg -C
...
adb shell cat /proc/vmstat | grep pswp
	...
	adb shell /data/launch/launch_app_track_switch.sh pubg
	sleep 100
#/home/user/hdd/kernel_flame/private/shell/play/pubg_play.sh
#sleep 100
...
sleep 10
adb shell dmesg > PU_dmesga_${num}.txt
sleep 30

cat PU_dmesga_${num}.txt | grep vma | grep "swapin tgid" > cut_PU_dmesga_${num}.txt
sleep 10
cat PU_dmesga_${num}.txt | grep vma | grep "swapout tgid" > out_a_${num}.txt
sleep 10
