...
sleep 2
sleep 10
adb shell cat /proc/$STR3/maps > CC_maps_${num}.txt
sleep 10
adb shell pmap -x $STR3 > CC_pmap_${num}.txt
sleep 10
adb shell dmesg > CC_dmesgb_${num}.txt
sleep 30
cat CC_dmesgb_${num}.txt | grep vma | grep "swapin tgid" > cut_CC_dmesgb_${num}.txt
sleep 10
cat CC_dmesgb_${num}.txt | grep vma | grep "swapout tgid" > out_b_${num}.txt
sleep 10
sleep 10
adb shell dmesg -C
...
adb shell cat /proc/vmstat | grep pswp
	...
	adb shell /data/launch/launch_app_track_switch.sh candycrush
sleep 100
...
sleep 10
adb shell dmesg > CC_dmesga_${num}.txt
sleep 30

cat CC_dmesga_${num}.txt | grep vma | grep "swapin tgid" > cut_CC_dmesga_${num}.txt
sleep 10
cat CC_dmesga_${num}.txt | grep vma | grep "swapout tgid" > out_a_${num}.txt
sleep 10
