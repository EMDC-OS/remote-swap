...
sleep 2
sleep 10
adb shell cat /proc/$STR8/maps > IG_maps_${num}.txt
sleep 10
adb shell pmap -x $STR8 > IG_pmap_${num}.txt
sleep 10
adb shell dmesg > IG_dmesgb_${num}.txt
sleep 30
cat IG_dmesgb_${num}.txt | grep vma | grep "swapin tgid" > cut_IG_dmesgb_${num}.txt
sleep 10
cat IG_dmesgb_${num}.txt | grep vma | grep "swapout tgid" > out_b_${num}.txt
sleep 10
sleep 10
adb shell dmesg -C
...
adb shell cat /proc/vmstat | grep pswp
	adb shell /data/launch/launch_app_track_switch.sh instagram
sleep 100
adb shell cat /proc/vmstat | grep pg.*fault
adb shell cat /proc/vmstat | grep pswp

sleep 10
adb shell dmesg > IG_dmesga_${num}.txt
sleep 30
cat IG_dmesga_${num}.txt | grep vma | grep "swapin tgid" > cut_IG_dmesga_${num}.txt
sleep 10
cat IG_dmesga_${num}.txt | grep vma | grep "swapout tgid" > out_a_${num}.txt
sleep 10
