...
adb shell dmesg > ${app}_dmesg2_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg2_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg2_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg2.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg2.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg2.txt
sleep 10

adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg3_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg3_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg3_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg3.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg3.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg3.txt
sleep 10
...
adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg4_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg4_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg4_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg4.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg4.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg4.txt
sleep 10


adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg5_b.txt
sleep 10
adb shell dmesg -C
sleep 30
cat ${app}_dmesg5_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg5_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg5.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg5.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg5.txt
sleep 10
...
adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg6_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg6_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg6_b.txt
sleep 10
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg6.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg6.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg6.txt
sleep 10

adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg7_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg7_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg7_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg7.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg7.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg7.txt
sleep 10
...
adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg8_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg8_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg8_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg8.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg8.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg8.txt
sleep 10


adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg9_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg9_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg9_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg9.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg9.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg9.txt
sleep 10


adb shell /data/launch/launch_app.sh webview
sleep 60
adb shell dmesg > ${app}_dmesg10_b.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg10_b.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg10_b.txt
sleep 10
adb shell "echo anon > /proc/$STR1/reclaim"
sleep 5
adb shell "echo $STR1 > /proc/sys/kernel/swapcache_flush"
...
adb shell cat /proc/$STR1/status | awk 'NR==19 || NR==20'
sleep 5
adb shell dmesg > ${app}_dmesg10.txt
sleep 5
adb shell dmesg -C
sleep 30
cat ${app}_dmesg10.txt | grep vma | grep "swapin tgid" > cut_${app}_dmesg10.txt
sleep 10
